...
This is a node.js fork of the [yoheinakajima/babyagi](https://github.com/yoheinakajima/babyagi) python project.

The README has slight changes for Node.js, but otherwise remains the unchanged.
